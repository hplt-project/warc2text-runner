...
def buildsketch(outpath, fpath='-', domain_level=False, ngrams=-1, p=18, debug=False):
    """
    ...
    if domain_level:
        ...
        url_preprocess = lambda line: (line[i:i+ngrams] for i in range(max(1,len(line)-ngrams+1)))
